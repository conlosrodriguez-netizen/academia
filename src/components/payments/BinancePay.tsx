  ...
  if (submitted) {
    return (
      <div style={{ textAlign: 'center', padding: '40px 0' }}>
        ...
        <button onClick={onSuccess} style={{ borderRadius: 10, background: '#f59e0b', padding: '10px 20px', fontSize: 13, fontWeight: 700, color: 'white', border: 'none', cursor: 'pointer' }}>
          Entendido
        </button>
      </div>
    );
    ...
    <div>
          ...
          {capturePreview ? (
            ...
            <>
              ...
              <div style={{ textAlign: 'center' }}>
                ...
                <span style={{ fontSize: 11, color: '#9ca3af' }}>Foto de la transacción en Binance</span>
              </div>
            </>
          )}
      ...
      <button
        ...
        style={{
          ...
          fontSize: 13,
          fontWeight: 700,
          background: captureFile ? '#f59e0b' : '#d1d5db',
          color: 'white',
          border: 'none',
